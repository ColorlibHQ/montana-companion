...
class montana_contactinfo_widget extends WP_Widget {
...
'montana_contactinfo_widget', 


// Widget name will appear in UI
esc_html__( '[ Montana ] Contact Info', 'montana-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer contact info', 'montana-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Contact Info', 'montana-companion' );
}
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'addressicon' ) ); ?>"><?php _e( 'Icon', 'montana-companion' ); ?>:</label>
    <div class="montana-media-container">
        <div class="montana-media-inner">
            ...
            <span class="montana-no-image" id="<?php echo wp_kses_post( $this->get_field_id( 'addressicon' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'montana-companion' ); ?></span>
        </div>
    
    <input type="text" id="<?php echo wp_kses_post( $this->get_field_id( 'addressicon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'addressicon' ) ); ?>" value="<?php echo esc_attr( $addressicon ); ?>" class="montana-media-url" />

    <input type="button" value="<?php echo _e( 'Remove', 'montana-companion' ); ?>" class="button montana-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'addressicon' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

    <?php $button_text = ( $addressicon != '' ) ? __( 'Change Image', 'montana-companion' ) : __( 'Select Image', 'montana-companion' ); ?>
    <input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button montana-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'addressicon' ) ); ?>-button" />
    <br class="clear">
    </div>
</p>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'address' ) ); ?>"><?php esc_html_e( 'Address:' ,'montana-companion'); ?></label> 
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>"><?php _e( 'Icon', 'montana-companion' ); ?>:</label>
    <div class="montana-media-container">
        <div class="montana-media-inner">
            ...
            <span class="montana-no-image" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'montana-companion' ); ?></span>
        </div>
    
    <input type="text" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'pnumbericon' ) ); ?>" value="<?php echo esc_attr( $pnumbericon ); ?>" class="montana-media-url" />

    <input type="button" value="<?php echo _e( 'Remove', 'montana-companion' ); ?>" class="button montana-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

    <?php $button_text = ( $pnumbericon != '' ) ? __( 'Change Image', 'montana-companion' ) : __( 'Select Image', 'montana-companion' ); ?>
    <input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button montana-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>-button" />
    <br class="clear">
    </div>
</p>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'pnumber' ) ); ?>"><?php esc_html_e( 'Phone Number:' ,'montana-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>"><?php _e( 'Icon', 'montana-companion' ); ?>:</label>
	<div class="montana-media-container">
		<div class="montana-media-inner">
			...
			<span class="montana-no-image" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'montana-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'emailicon' ) ); ?>" value="<?php echo esc_attr( $emailicon ); ?>" class="montana-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'montana-companion' ); ?>" class="button montana-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $emailicon != '' ) ? __( 'Change Image', 'montana-companion' ) : __( 'Select Image', 'montana-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button montana-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Email:' ,'montana-companion'); ?></label> 
...
function montana_contactinfo_load_widget() {
	register_widget( 'montana_contactinfo_widget' );
}
add_action( 'widgets_init', 'montana_contactinfo_load_widget' );