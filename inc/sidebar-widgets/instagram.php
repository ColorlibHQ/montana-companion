...
----------------------------------------*/
class montana_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('montana_instagram_photo',esc_html__('[ Montana ] Intagram Photo','montana'),array(
			'description' => esc_html__('Montana Instagram Photo Widget','montana'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'montana');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'montana'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'montana'); ?></label>
...
if(!function_exists('montana_instagram_widgets')):
	function montana_instagram_widgets(){
		register_widget('montana_instagram_photo');
	}
	add_action('widgets_init','montana_instagram_widgets');
endif;
