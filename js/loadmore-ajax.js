 ...
 * over admin-ajax into .montana-portfolio-load and lays the Isotope grid out
        ...
        Array.prototype.forEach.call(loadbuttons, function (button) {
            button.addEventListener('click', function (e) {
                ...
                UI.request(portfolioloadajax.action_url, {
                    ...
                    UI.toElements('.montana-portfolio-load').forEach(function (el) {
                        el.innerHTML = html;
                    });

                    UI.isotope('.montana-portfolio', 'reloadItems');
                    UI.isotope('.montana-portfolio', {
